...
export default function RecommendPeople({
  ...
  if (imageSrc === null) {
    if (status === "용달") {
      setImageSrc("/truck.png");
    } else {
      setImageSrc("/clean.png");
    }
  }
      ...
      >
        ...
        <div className="d-flex col-md-8 flex-column justify-content-center gap-3">
          <div className="gap-3 d-flex justify-content-center ">
            <div className="m-0  col-md-3 fw-bold d-flex align-items-center">
              {" "}
              {imgsrc === "" ? null : (
                <img
                  className="rounded-pill"
          ...
          <div className="gap-3 d-flex justify-content-center">
            {tag &&
              tag.slice(0, 3).map((item, index) => (
                <div
                  key={index}
                  className="border border-primary rounded-5 d-flex align-items-center justify-content-center p-2 bg-white col-3 text-center"
                >
