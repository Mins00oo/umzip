  ...
  return (
    <>
      ...
      >
        ...
        <div
          className=" rounded-pill p-1 position-absolute top-5 start-0 translate-middle bg-white "
          style={{ borderBottom: "solid 3px #a1c4fd" }}
        >
          {requestList === "용달" ? (
            <img
              className=" rounded-pill"
              style={{ width: "2.75rem", height: "2.75rem" }}
              src="/free-icon-fast-delivery-6491506.png"
            />
          ) : (
            <img
              className=" rounded-pill"
              style={{ width: "2.75rem", height: "2.75rem" }}
              src="/free-icon-cleaning-tools-2452217.png"
            />
          )}
        </div>
