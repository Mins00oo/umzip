...
function ReplyTo({ chatModal, role, status, mappingId, reissuing, memberId }) {
  ...
  const rejectionReservation = useReplyStore(
    (state) => state.rejectionReservation
  );
  ...
  return (
    <div>
      ...
      {code === 3 && (
        ...
        <div onClick={() => chatStart()} className={styles.uiverseChat}>
      ...
      {/* 제안 거절시 */}
      {code === 4 && (
        <div className={styles.uiverseComplete}>
